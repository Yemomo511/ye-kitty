...
import { XiaohongshuMentionSource } from './xiaohongshu-mention-source';
import { JsonXiaohongshuMentionCheckpointRepository } from '../infrastructure/json-xiaohongshu-mention-checkpoint.repository';
import { McpXiaohongshuMentionReader } from '../infrastructure/mcp-xiaohongshu-mention.reader';
import type { XiaohongshuMcpRawToolCallerPort } from '../ports/xiaohongshu-mcp-raw-tool-caller.port';

/** 小红书被提及信息源工厂参数 */
export interface CreateXiaohongshuMentionSourceOptions {
  readonly caller: XiaohongshuMcpRawToolCallerPort;
