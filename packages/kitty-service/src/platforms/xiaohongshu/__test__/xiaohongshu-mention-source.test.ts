...
import { XiaohongshuMentionSource } from '../application/xiaohongshu-mention-source';
import type { XiaohongshuMentionPage } from '../domain/xiaohongshu-mention';
...
describe('小红书被提及信息源', () => {
  test('首次只建立基线，后续新提醒按时间顺序广播并去重', async () => {
    ...
    const events: XiaohongshuMentionEventContract[] = [];
