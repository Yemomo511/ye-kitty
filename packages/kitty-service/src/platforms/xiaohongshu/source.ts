...
import type { XiaohongshuMention, XiaohongshuMentionCheckpoint } from './message';
 ...
 * 后续才按时间顺序发布未见提醒。
 */
export class XiaohongshuMentionSource extends PlatformMessageService<XiaohongshuMessage> {
...
function toEvent(mention: XiaohongshuMention, receivedAt: Date): XiaohongshuMessage {
