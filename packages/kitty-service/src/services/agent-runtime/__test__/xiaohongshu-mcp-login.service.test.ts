...
import { XiaohongshuMcpLoginService } from '../application/xiaohongshu-mcp-login.service';
...
import type { XiaohongshuQrcodePresenterPort } from '../ports/xiaohongshu-qrcode-presenter.port';
...
function createCaller(results: McpToolCallResult[]) {
  ...
  } satisfies McpRawToolCallerPort;
}
