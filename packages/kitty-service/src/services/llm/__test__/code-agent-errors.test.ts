/**
 * Task 2 测试 — code-agent 错误类
 * 测试 3 个错误类的构造与属性（TDD 红灯先行→绿灯）。
 */
import { describe, it, expect } from 'vitest';
import {
  CodeAgentGateRejectedError,
  CodeAgentSessionClosedError,
  CodeAgentPipeBrokenError,
} from '@kitty/services/llm/domain/code-agent-errors';

describe('CodeAgentGateRejectedError', () => {
  it('T2-1: 应正确设置 name、message 和 cause', () => {
...
describe('CodeAgentSessionClosedError', () => {
  it('T2-2: 应正确设置 sessionId 和 currentStatus', () => {
...
describe('CodeAgentPipeBrokenError', () => {
  it('T2-3: 应正确设置 sessionId，含 stdin 管道断开语义', () => {
