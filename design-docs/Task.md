...
| 模块                         | 设计文档                                                        | 状态   | 进度说明                                                                                                                                                                                                                                                                                                                                                               |
| ---------------------------- | --------------------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Kitty Service 三层模块化重构 | `design-docs/Architecture/platform-agent-shared-refactor.md`    | 开发中 | 阶段 0 已完成；Action、Prompt、Skills、Tools 与 Schedule 已建立。Skill 目录、正文、引用已从旧四层迁入单一模块，`skill` Tool 只允许启用可见 Skill 或读取已启用 Skill 的引用；旧循环仍临时消费兼容 Decision，下一步让 Agent 直接消费 Action 和 ScheduleResult。                                                                                                          |
