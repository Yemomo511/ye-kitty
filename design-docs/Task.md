...
| 模块                         | 设计文档                                                        | 状态   | 进度说明                                                                                                                                                                                                                                                                                                                                                               |
| ---------------------------- | --------------------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Kitty Service 三层模块化重构 | `design-docs/Architecture/platform-agent-shared-refactor.md`    | 开发中 | 阶段 0 已建立 `agent-runtime`、`platforms`、`shared` 公开入口和 12 项架构规则测试；新校验已从“要求四层骨架”改为“禁止三层反向依赖 + 旧结构递减债务额度”，下一步迁移 AgentAction、Prompt、Skills、Tools 与 Schedule。                                                                                                                                                    |
