...
| 模块                         | 设计文档                                                        | 状态   | 进度说明                                                                                                                                                                                                                                                                                                                                                               |
| ---------------------------- | --------------------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Kitty Service 三层模块化重构 | `design-docs/Architecture/platform-agent-shared-refactor.md`    | 开发中 | Agent、Action、Context、Message、Prompt、Skills、Tools 与 Schedule 已迁入目标结构。Agent 只通过 Schedule 执行 ToolAction，模型 Runner 已直接返回 AgentAction；下一步迁移 LM、Model Pool 与 Code Agent。                                                                                                                                                                |
